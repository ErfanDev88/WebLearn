...
import Semantic from "../../assets/png/Semantic-Tags-1.jpg";
import useDivAndSpan from "../../assets/png/useDivAndSpan.jpg";
import useClassID from "../../assets/png/useClassID.jpg";
import iframe from "../../assets/png/iframe.jpg";
import forms from "../../assets/png/forms.jpg";
import audioVideoTag from "../../assets/png/audioVideoTag.jpg";
import tableTag from "../../assets/png/tableTag.jpg";
import hyperlink from "../../assets/png/hyperlink.jpg";
import BlogsCard from "./BlogsCard";

function BlogsCardLists() {
  const [blogs, setBlogs] = useState([
    {
      title: "تگ معنایی یا Semantic در HTML چیست و چگونه از آن استفاده کنیم؟",
      imageUrl: Semantic,
      id: "Semantic",
      url: 'https://metawebz.org/mag/html-training-part-15/'
    },
    {
      title: "کاربرد و آموزش استفاده از تگ های div و span در زبان HTML",
      imageUrl: useDivAndSpan,
      id: "use-div-and-span",
      url: 'https://metawebz.org/mag/html-training-part-14/'
    },
    {
      title: "نحوه کار با کلاس و ID در HTML",
      imageUrl: useClassID,
      id: "use-class-ID",
      url: 'https://metawebz.org/mag/html-training-part-13/'
    },
    {
      title: "آموزش قاب درون خطی (iframe) در HTML",
      imageUrl: iframe,
      id: "iframe",
      url: 'https://metawebz.org/mag/html-training-part-12/'
    },
    {
      title: "آموزش کار با فرم ها یا Forms در سند HTML",
      imageUrl: forms,
      id: "forms",
      url: 'https://metawebz.org/mag/html-training-part-11/'
    },
    {
      title: "آشنایی با تگ صدا audio و تگ ویدیو video در HTML",
      imageUrl: audioVideoTag,
      id: "audio-video-tag",
      url: 'https://metawebz.org/mag/html-training-part-10/'
    },
    {
      title: "آموزش ایجاد جدول HTML با استفاده از تگ Table",
      imageUrl: tableTag,
      id: "table-tag",
      url: 'https://metawebz.org/mag/html-training-part-9/'
    },
    {
      title: 'چگونه لینک یا پیوند یا hyperlink در HTML قرار دهیم؟',
      imageUrl: hyperlink,
      id: "hyperlink",
      url: 'https://metawebz.org/mag/html-training-part-8/'
    },
  ]);
  return (
