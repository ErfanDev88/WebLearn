...
function About() {
  return (
    <section className="w-full flex flex-col justify-between mt-16 gap-y-10">
      <h1 data-aos="fade-left" className="text-slate-700 text-xl font-black flex items-center dark:text-white">
        <svg
          width="18"
          height="26"
          viewBox="0 0 32 40"
      ...
      <div data-aos="zoom-in" className="w-full flex flex-col justify-between items-center px-5 bg-white rounded-xl shadow-4xl gap-y-4 md:flex-row md:gap-y-0 md:py-10 md:px-14 md:items-start dark:bg-[#202e41] pb-5">
        ...
        <div className="w-full flex flex-col justify-between gap-y-4 md:w-2/3 md:items-start md:gap-y-8">
          ...
          <p className="text-sm font-shabnamLight font-light text-[#242b35] md:text-lg md:leading-relaxed md:w-2/3 dark:text-white">
            ...
            هستم و با فریموورک ها و کتابخانه هایی مثل tailwindcss, ReactJS... کار میکنم.
            من یه طراح رابط کاربری UI & UX هم هستم که با فیگما کار میکنم و طرح های زیبا  و متنوع برای سایت ها انجام میدم. برای دیدن نمونه کار های طراحی من روی 
            <Link to={"https://dribbble.com/M-erfan/"} className="font-medium md:text-xl text-base"> اینجا </Link>
            کلیک کنید.
          </p>
        </div>
      </div>
