...
function SingleSkillPage(props) {
  ...
  return (
    <>
      ...
      <section data-aos="zoom-in" className="w-full flex flex-col justify-between items-center p-8 rounded-2xl mt-16 bg-[#202e41] gap-y-10">
      ...
      <section className="w-full md:flex-row flex flex-col justify-between items-start p-8 rounded-2xl mt-16 bg-[#202e41] md:gap-x-10 gap-x-0 gap-y-10">
        <div className="md:w-1/6 w-full md:border-r border-r-0 border-b md:border-b-0 border-gray-400/20 md:order-1">
          <div data-aos="fade-up" className="md:pr-5 pr-0 pb-5 md:pb-0 md:flex-col flex flex-row justify-between items-center md:gap-y-5 gap-y-0">
        ...
        <div className="md:w-5/6 w-full flex flex-col justify-between items-start gap-y-5">
          <h1 data-aos="fade-left" className="text-2xl text-white font-black mb-7">سرفصل دوره</h1>
          <div data-aos="zoom-in" className="w-full flex justify-start items-start py-4 px-6 rounded-lg bg-slate-700 text-xl text-white font-bold gap-x-8">
